...
execute if score #custom_painting.interaction.is_sneaking mcpaint.calc matches 0 run scoreboard players add #custom_painting.toggle_value mcpaint.calc 1
execute if score #custom_painting.interaction.is_sneaking mcpaint.calc matches 1 run scoreboard players remove #custom_painting.toggle_value mcpaint.calc 1
$execute if score #custom_painting.toggle_value mcpaint.calc matches ..-1 run scoreboard players add #custom_painting.toggle_value mcpaint.calc $(values)
...
$function mcpaint:custom_painting/internal/toggle/$(option) with storage mcpaint:calc internal.custom_painting.data.options

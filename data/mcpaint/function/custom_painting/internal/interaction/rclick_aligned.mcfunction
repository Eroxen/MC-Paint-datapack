...
scoreboard players set #custom_painting.interaction.send_title mcpaint.calc 0
...
execute if score #custom_painting.interaction.used_item mcpaint.calc matches 1 if data storage mcpaint:calc internal.custom_painting.used_item.components."minecraft:custom_data".mcpaint{projector_tape:1b} run function mcpaint:custom_painting/internal/interaction/click_projector_tape
...
execute if score #custom_painting.interaction.send_title mcpaint.calc matches 1 on target run title @s actionbar {"storage":"mcpaint:calc","nbt":"internal.custom_painting.title","interpret": true}
...
scoreboard players set #custom_painting.interaction.clicked mcpaint.calc 0
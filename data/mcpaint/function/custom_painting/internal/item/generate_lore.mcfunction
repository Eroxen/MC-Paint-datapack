...
'{"translate":"item.mcpaint.custom_painting.lore.size","color":"white","italic":false,"with":[$(width_blocks),$(height_blocks),{"translate":"item.mcpaint.custom_painting.lore.size_detail","color":"dark_gray","with":[$(width_px),$(height_px),$(text_size_formatted)]}]}',\
]

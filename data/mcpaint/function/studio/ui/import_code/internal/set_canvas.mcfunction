...
execute as @e[type=text_display,tag=mcpaint.studio.ui_element.import_code.canvas,distance=..0.1,limit=1] run function mcpaint:canvas/api/apply_to_text_display {axis_shading:0b}

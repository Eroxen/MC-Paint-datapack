...
execute if score #studio.ui_element.focused_child mcpaint.calc matches 7 run data modify storage mcpaint:calc internal.studio.title set value '{"translate":"mcpaint.ui.button.encode"}'
...
execute if score #studio.ui_element.focused_child mcpaint.calc matches 5..6 unless data entity @s data{selected_work:-1} run scoreboard players set #studio.ui_element.focused_child.can_click mcpaint.calc 1
...
execute if score #studio.ui_element.focused_child mcpaint.calc matches 1..6 run scoreboard players set #studio.ui_element.focused_child.has_description mcpaint.calc 1
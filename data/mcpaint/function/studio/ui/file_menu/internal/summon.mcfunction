$summon text_display ~ ~ ~ {Rotation:$(rotation),Tags:["mcpaint.entity","mcpaint.studio","mcpaint.studio.text_display","mcpaint.studio.text_display.highlightable.see_through","mcpaint.studio.text_display.highlightable.text_opacity","mcpaint.studio.ui_element","mcpaint.studio.ui_element.parent","mcpaint.studio.ui_element.file_menu","mcpaint.studio.ui_element.subscribe.history_changed","mcpaint.studio.ui_element.subscribe.saved"],background:0,line_width:10000,transformation:$(transformation),text_opacity:-30b,see_through:1b,alignment:"left",Passengers:[\
{id:"minecraft:marker",Tags:["mcpaint.entity","mcpaint.studio","mcpaint.studio.ui_element","mcpaint.studio.ui_element.child"]},\
{id:"minecraft:text_display",Rotation:$(rotation),Tags:["mcpaint.entity","mcpaint.studio","mcpaint.studio.ui_element","mcpaint.studio.ui_element.child","mcpaint.studio.ui_element.file_menu.filename","mcpaint.studio.text_display.highlightable.see_through"],background:0,see_through:1b,line_width:10000,transformation:$(filename_transform)}]}

$summon text_display ~ ~ ~ {Rotation:$(rotation),Tags:["mcpaint.entity","mcpaint.studio","mcpaint.studio.text_display","mcpaint.studio.ui_element","mcpaint.studio.ui_element.parent","mcpaint.studio.ui_element.file_menu","mcpaint.studio.ui_element.subscribe.history_changed","mcpaint.studio.ui_element.subscribe.saved"],background:0,line_width:10000,transformation:$(transformation),text_opacity:-30b,alignment:"left",Passengers:[\

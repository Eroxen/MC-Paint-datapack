$summon text_display ~ ~ ~ {Rotation:$(rotation),Tags:["mcpaint.entity","mcpaint.studio","mcpaint.studio.text_display","mcpaint.studio.text_display.highlightable.text_opacity","mcpaint.studio.ui_element","mcpaint.studio.ui_element.parent","mcpaint.studio.ui_element.tools"],background:0,line_width:10000,transformation:$(transformation),text_opacity:-10b,alignment:"left",text:'{"storage":"mcpaint:calc","nbt":"internal.studio.tools.window.text_rows[]","separator":"\\n","interpret":true}',Passengers:[\

data modify storage mcpaint:calc internal.settings.client_default set value {send_rp_message:1b,send_welcome_message:1b,protect_studio:1b,egg_banter:1b}

...
protect_studio:'{"text":"\\u0001","font":"mcpaint:chat_ui","clickEvent":{"action":"run_command","value":"/trigger mcpaint.settings set 10002"}}'\
}
...
'{"text":"\\u0002","font":"mcpaint:chat_ui","clickEvent":{"action":"run_command","value":"/trigger mcpaint.settings set 10003"}}'

...
send_welcome_message:'{"text":"\\u0001","font":"mcpaint:chat_ui","clickEvent":{"action":"run_command","value":"/trigger mcpaint.settings set 10007"}}',\
...
execute if data storage mcpaint:calc api.settings.client{send_welcome_message:0b} run data modify storage mcpaint:calc internal.settings.client_menu.send_welcome_message set value \
'{"text":"\\u0002","font":"mcpaint:chat_ui","clickEvent":{"action":"run_command","value":"/trigger mcpaint.settings set 10008"}}'
...
tellraw @s {"text":"","extra":[{"storage":"mcpaint:calc","nbt":"internal.settings.client_menu.send_welcome_message","interpret": true},{"text":" "},{"translate":"mcpaint.settings.client.send_welcome_message.title"},{"text":" "},{"text":"?","color":"gray","hoverEvent":{"action":"show_text","contents":[{"translate":"mcpaint.settings.client.send_welcome_message.info"}]}}]}

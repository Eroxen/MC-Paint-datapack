...
scoreboard players operation offset_x mcpaint.calc *= canvas_width_blocks mcpaint.calc
scoreboard players operation offset_x mcpaint.calc /= canvas_width_px mcpaint.calc
scoreboard players set op mcpaint.calc 2
scoreboard players operation offset_x2 mcpaint.calc = canvas_width_blocks mcpaint.calc
...
scoreboard players operation offset_y mcpaint.calc *= canvas_height_blocks mcpaint.calc

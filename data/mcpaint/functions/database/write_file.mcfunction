...
data modify storage mcpaint:database search.work merge from storage mcpaint:database write_file

data modify storage mcpaint:database search.searched_works prepend from storage mcpaint:database search.work

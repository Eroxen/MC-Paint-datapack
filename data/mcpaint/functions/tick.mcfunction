...
execute as @a unless score @s mcpaint.leave_game matches 0 at @s run function mcpaint:join_game
...
execute as @a[scores={mcpaint.settings=1..}] at @s run function mcpaint:trigger/settings

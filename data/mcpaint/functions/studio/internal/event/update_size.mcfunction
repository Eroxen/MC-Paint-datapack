...
data modify entity @s data.width set from storage mcpaint:calc internal.studio.data.width
data modify entity @s data.height set from storage mcpaint:calc internal.studio.data.height

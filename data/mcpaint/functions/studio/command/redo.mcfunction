...
data modify storage mcpaint:calc historical_event set from entity @s data.history.redo[0]
data remove entity @s data.history.redo[0]
...
execute if data storage mcpaint:calc inv_historical_event run function mcpaint:studio/add_history

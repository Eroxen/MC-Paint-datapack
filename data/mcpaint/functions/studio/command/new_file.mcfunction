...
execute store result score #canvas.width_blocks mcpaint.calc run data get storage mcpaint:calc popup.width_blocks
execute store result score #canvas.height_blocks mcpaint.calc run data get storage mcpaint:calc popup.height_blocks
execute store result score #canvas.width_px mcpaint.calc run data get storage mcpaint:calc popup.width_px
execute store result score #canvas.height_px mcpaint.calc run data get storage mcpaint:calc popup.height_px

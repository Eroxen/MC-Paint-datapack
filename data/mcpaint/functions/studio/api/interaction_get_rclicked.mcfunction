...
execute positioned ~ ~1 ~ align x align y align z positioned ~0.5 ~0.5 ~0.5 as @e[type=marker,tag=mcpaint.studio.marker,distance=..0.1,limit=1] run function mcpaint:studio/internal/get_right_clicked

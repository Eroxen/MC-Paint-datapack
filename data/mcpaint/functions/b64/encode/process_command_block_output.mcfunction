...
data modify storage mcpaint:calc b64.encode.cut_string set string storage mcpaint:calc b64.encode.command_block_output 91
...
scoreboard players remove length mcpaint.calc 38

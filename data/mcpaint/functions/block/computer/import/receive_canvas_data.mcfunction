...
scoreboard players operation scale_blocks mcpaint.calc = #canvas.width_blocks mcpaint.calc
scoreboard players operation scale_blocks mcpaint.calc > #canvas.height_blocks mcpaint.calc
...
scoreboard players operation offset_y2 mcpaint.calc *= #canvas.height_blocks mcpaint.calc
...
data modify entity @s data.computer_page.canvas set from storage mcpaint:calc api.canvas.canvas

...
execute store result storage mcpaint:calc internal.studio.ui.data.tool.index.subtool int 1 run scoreboard players get #studio.ui_element.selected mcpaint.calc

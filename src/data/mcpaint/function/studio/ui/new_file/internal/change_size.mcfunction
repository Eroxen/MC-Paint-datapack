...
execute if score #studio.ui_element.focused_child mcpaint.calc matches 11..12 run data modify entity @e[type=text_display,tag=mcpaint.studio.ui_element.new_file.width_blocks,distance=..0.1,limit=1] text set value {"storage":"mcpaint:calc","plain":true,"nbt":"internal.studio.ui.data.width_blocks","color":"white"}
execute if score #studio.ui_element.focused_child mcpaint.calc matches 11..14 run data modify entity @e[type=text_display,tag=mcpaint.studio.ui_element.new_file.width_px,distance=..0.1,limit=1] text set value {"storage":"mcpaint:calc","plain":true,"nbt":"internal.studio.ui.data.width_px","color":"white"}
execute if score #studio.ui_element.focused_child mcpaint.calc matches 15..16 run data modify entity @e[type=text_display,tag=mcpaint.studio.ui_element.new_file.height_blocks,distance=..0.1,limit=1] text set value {"storage":"mcpaint:calc","plain":true,"nbt":"internal.studio.ui.data.height_blocks","color":"white"}
execute if score #studio.ui_element.focused_child mcpaint.calc matches 15..18 run data modify entity @e[type=text_display,tag=mcpaint.studio.ui_element.new_file.height_px,distance=..0.1,limit=1] text set value {"storage":"mcpaint:calc","plain":true,"nbt":"internal.studio.ui.data.height_px","color":"white"}
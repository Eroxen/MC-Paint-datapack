...
data modify storage mcpaint:calc internal.studio.ui.data merge value {filepath:{},filename_text:{"storage":"mcpaint:calc","interpret":true,"nbt":"internal.studio.ui.data.filepath.name","color":"white"},width_px:16,height_px:16,width_blocks:1,height_blocks:1}
...
function mcpaint:database/api/get_default_filename with storage mcpaint:calc internal.studio.ui.data.filepath

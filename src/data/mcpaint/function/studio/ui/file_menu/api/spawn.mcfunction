...
data modify storage mcpaint:calc internal.studio.ui.data merge value {filepath:{},filename_text_parts:{name:"unnamed",bytes:"",save_indicator:"",height:0,width:0},filename_text:{"text":"","color":"black","extra":[{"storage":"mcpaint:calc","interpret":true,"nbt":"internal.studio.ui.data.filename_text_parts.name"},{"storage":"mcpaint:calc","interpret":true,"nbt":"internal.studio.ui.data.filename_text_parts.save_indicator"},{"text":" ("},{"storage":"mcpaint:calc","plain":true,"nbt":"internal.studio.ui.data.filename_text_parts.width"},{"text":"x"},{"storage":"mcpaint:calc","plain":true,"nbt":"internal.studio.ui.data.filename_text_parts.height"},{"text":"px)"}]},text_macro:{save:"\\u0201",save_as:"\\u0202",load:"\\u0203",new_file:"\\u0204",undo:"\\u0217",redo:"\\u0218"}}

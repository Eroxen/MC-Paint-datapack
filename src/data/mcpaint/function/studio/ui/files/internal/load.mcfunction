...
tellraw @p[predicate=mcpaint:same_session] {"translate":"mcpaint.message.loaded_from_file","with":[{"storage":"mcpaint:calc","interpret":true,"nbt":"internal.studio.data.filepath.name"}]}

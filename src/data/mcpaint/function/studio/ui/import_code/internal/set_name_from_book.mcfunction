...
data modify entity @e[type=text_display,tag=mcpaint.studio.ui_element.import_code.filename,distance=..0.1,limit=1] text set value {"storage":"mcpaint:calc","interpret":true,"nbt":"internal.studio.ui.data.filepath.name","color":"white"}
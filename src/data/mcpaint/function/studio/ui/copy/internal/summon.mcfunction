$summon text_display ~ ~ ~ {Rotation:$(rotation),Tags:["mcpaint.entity","mcpaint.studio","mcpaint.studio.text_display","mcpaint.studio.text_display.highlightable.text_opacity","mcpaint.studio.ui_element","mcpaint.studio.ui_element.parent","mcpaint.studio.ui_element.copy"],background:0,line_width:10000,transformation:$(transformation),text_opacity:-10b,alignment:"left",text:{"text":"\u1001\u0307","color":"white","font":"mcpaint:studio_ui"},Passengers:[\

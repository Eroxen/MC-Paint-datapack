...
data modify storage mcpaint:calc internal.studio.ui.data merge value {filename_text:{"storage":"mcpaint:calc","interpret":true,"nbt":"internal.studio.ui.data.filepath.name","color":"white"}}

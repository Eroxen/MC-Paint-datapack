...
execute if score #custom_painting.interaction.modifying mcpaint.calc matches 1 if entity @s[tag=mcpaint.custom_painting.locked] unless data storage mcpaint:calc internal.custom_painting.item_interaction.merge_options.locked run return fail
...
execute if data storage mcpaint:calc internal.custom_painting.item_interaction.merge_options{locked:0b} run data modify storage mcpaint:calc internal.custom_painting.compare_uuid set from storage mcpaint:calc internal.custom_painting.data.owner
execute if data storage mcpaint:calc internal.custom_painting.item_interaction.merge_options{locked:0b} store success score #custom_painting.different mcpaint.calc run data modify storage mcpaint:calc internal.custom_painting.compare_uuid set from storage mcpaint:calc internal.custom_painting.user
execute if data storage mcpaint:calc internal.custom_painting.item_interaction.merge_options{locked:0b} if score #custom_painting.different mcpaint.calc matches 1 run return fail
execute if data storage mcpaint:calc internal.custom_painting.item_interaction.merge_options.locked run function mcpaint:custom_painting/internal/toggle/locked
...
execute if data storage mcpaint:calc internal.custom_painting.item_interaction.particle run function mcpaint:custom_painting/internal/interaction/play_particle with storage mcpaint:calc internal.custom_painting.item_interaction.particle

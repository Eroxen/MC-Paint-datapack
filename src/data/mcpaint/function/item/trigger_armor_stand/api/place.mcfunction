...
execute store result storage mcpaint:calc api.trigger_armor_stand.placer.is_sneaking byte 1 if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{"minecraft:type_specific/player":{input:{sneak:1b}}}}

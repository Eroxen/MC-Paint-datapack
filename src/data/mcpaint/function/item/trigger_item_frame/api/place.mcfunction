...
execute store result storage mcpaint:calc api.trigger_item_frame.placer.is_sneaking byte 1 if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{type_specific:{type:"minecraft:player",input:{sneak:1b}}}}

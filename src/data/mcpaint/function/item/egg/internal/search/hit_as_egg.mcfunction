...
$execute $(align)run summon item_display ~ ~ ~ {Rotation:$(rotation),item:{id:"minecraft:poisonous_potato",components:{"minecraft:item_model":"mcpaint:feedback_egg"}},Tags:["mcpaint.entity","mcpaint.egg_splat","mcpaint.egg_splat.new"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0.15f],scale:[0.9f,0.9f,1.4f]}}
